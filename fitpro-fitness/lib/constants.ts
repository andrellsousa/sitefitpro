...
export const navItems = [
  // Aponta para o topo da página, a seção principal (Hero)
  { name: "Home", href: "#home" },

  // Aponta para a seção onde você listará os 'programs'
  { name: "Programs", href: "#programs" },

  // A seção 'About' pode ser onde você mostra os depoimentos ('testimonials')
  { name: "About", href: "#about" },

  // Aponta para a seção de preços, onde você listará os 'plans'
  { name: "Pricing", href: "#pricing" },

  // Aponta para a seção final de contato, provavelmente no rodapé
  { name: "Contact", href: "#contact" },
];

// ... (o resto do arquivo 'programs', 'testimonials', 'plans' permanece o mesmo);
